    ...
    <article  class="inline text-right  ">
        <div id="menu" class=" ">
          ...
          <div id="imagem2" class="w-[100%] h-[350px]" >
            ...
            <!---->
            <section>
                <div id="caixa-texto"  class=" border border-white-500 border-2 rounded-[20px]  w-[70%] h-[250px] ml-[15%] mt-[10%] " >
                <p id="texto_em_breve" class="text-xl text-white mt-[10%] ">
                   EM BREVE NOVIDADES
        ...
        <section class="w-[75%] mx-[15%] mt-[15%] inline-block flex justify-center ">
            ...
            <div class="w-[45%] h-[30%] inline-block  m-[20px]" >
                <div id="caixa-texto" class=" border border-white-500 border-2 rounded-[20px]  p-[20px] w-[450px] h-[250px]" >
                    <p class="text-xl">Cadastre seu EMAIL para receber os
                     UPDATES em primeira-mão!</p>
                    ...
                    <label for="aceitar">Eu li e concordo com os termos de privacidade</label><br><br>
